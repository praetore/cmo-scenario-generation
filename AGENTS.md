# CMO scenario generation — agent instructions

Primary guide for generating **Command: Modern Operations (CMO)** Lua scripts. Use it to produce syntactically correct, tactically coherent scenarios. Cursor loads this file automatically from the repository root.
...
| Path | Purpose |
| :--- | :--- |
| `AGENTS.md` | Primary agent instructions (this file) |
| `scripts/` | Python tooling — see **`scripts/README.md`** |
| `.cursor/rules/` | API reference, logic checks, bootstrap docs |
...
| Bootstrap API & recipes | **`scenario_bootstrap_reference.md`** + **`AGENTS.md` §9** |
